#!/usr/bin/env node
// Script de génération ponctuelle du dictionnaire (data/words.js).
...
const header = `// Dictionnaire de mots français communs (${result.length} mots).\n` +
  `// Généré à partir de FrequencyWords (hermitdave, licence MIT), filtré et nettoyé.\n` +
  `// Ne pas éditer à la main : voir tools/build-words.js\n`;
const body = `const WORDS = ${JSON.stringify(result)};\n`;
